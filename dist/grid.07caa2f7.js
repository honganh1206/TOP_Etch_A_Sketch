...
var currentColor = 'black'; // FUNCTIONS
...
function createGrid(gridNumber) {
  ...
  for (var i = 1; i <= gridArea; i++) {
    ...
    container.style.gridTemplateColumns = "repeat(".concat(gridNumber, ", 1fr)");
    container.style.gridTemplateRows = "repeat(".concat(gridNumber, ", 1fr)");
...
function eraseAllColor() {
  ...
  gridPixels.forEach(function (gridPixel) {
    return gridPixel.style.backgroundColor = "#ffffff";
  });
} // EXECUTIONS
// On Page Load


createGrid(16); // Event listeners
...
},{}]},{},["../.nvm/versions/node/v16.13.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","grid.js"], null)
//# sourceMappingURL=/grid.07caa2f7.js.map